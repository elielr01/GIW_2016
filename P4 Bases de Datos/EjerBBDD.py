...
listaInfoLibros = [('El Quijote', 'Miguel de Cervantes','Alianza','LIBRO','1988-06-11','España',12),
                    ('Marina', 'Carlos Ruiz Zafón','Edebé','CD','2003-05-10','España',18.95),
                    ('La hoguera de las vanidades','Tom Wolfe','RBA editores','DVD','2005-11-09','USA',22.25),
                    ('Los pilares de la Tierra','Ken Follet','Faber','LIBRO','2014-12-01','USA',12.95),
                    ('Otelo','William Shakespeare','Anaya','LIBRO','2013-04-11','Inglaterra',14.95),
                    ('Rimas y Leyendas','Gustavo Adolfo Becquer','Roca','LIBRO','2008-01-08','España',25.95),
                    ('Poesía','Juan Ramón Jimenez','P&J','LIBRO','2002-04-07','España',10.95)]

listaInfoCompradores = [('Juan Miedo','1955-10-23','608900890','La isla del tesoro,33','Getafe','Buen comprador'),
                        ('Pepe Pepino','1961-12-13','607899005','Plaza Mayor,56','Pozuelo',''),
                        ('Pepe Mur','1976-04-02','917895679','Esparteros,5','Getafe',''),
                        ('Mohamed Alí','1968-11-12','609440567','Juan sin miedo,40','Pozuelo','Le gusta la ciencia ficción'),
                        ('Alfredo Mesa','1986-08-17','690890456','Gran vía,56','Getafe','Le gustan los ensayos'),
                        ('Pedro Reyes','1957-08-25','917890056','Plaza de España,34','Pozuelo','Le gusta la historia'),
                        ('Isabel Olvido','1977-07-20','915678900','Principal,3','Getafe','Le gusta la novela de terror'),
                        ('Mariano Calcetines','1996-11-09','634567876','Aviación,34','Getafe',''),
                        ('María Calero','1984-11-08','645666900','Río Ebro,4','Las Rozas','') ]
